#!/usr/bin/env python3
"""
Fetch US stock data for multi-market-stock-analysis skill.

Usage:
    python3 fetch_us_data.py --ticker NVDA --days 252
...
def fetch_us_data(ticker, days=252):
    """
...
def main():
    args = parse_args()
    result = fetch_us_data(args.ticker, args.days)
